...
const handleSubmit = async () => {
  ...
  try {
    ...
    const resp = await makeUserAuthenticatedRequest(url, {
      method: method,
      headers: {
      ...
      <form @submit.prevent="handleSubmit">
        <CardContent class="grid gap-6">
          ...
          <div class="grid gap-2">
            ...
            <p v-if="!isEditMode" class="italic text-muted-foreground text-sm">
          ...
          <div class="grid gap-2">
            <Label>
              Categorie ({{ formData.categories.length }}/{{ MAX_CATEGORIES }})
            </Label>
            ...
            >
              <SelectTrigger>
                <SelectValue placeholder="Seleziona le categorie" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem
          ...
          <div class="flex items-center space-x-2">
            <Checkbox
              ...
              @update:modelValue="(val: any) => (formData.isFree = val)"
            />
