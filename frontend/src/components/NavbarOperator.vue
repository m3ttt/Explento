...
<template>
  <div
    class="flex w-full max-w-md items-center justify-between gap-2 p-2 mx-6 rounded-full bg-background shadow-sm pointer-events-auto"
  >
    <Button
      variant="ghost"
      :class="[
        'flex-1 rounded-full hover:bg-muted',
        activeTab === '/operator' ? 'bg-muted text-primary' : '',
      ]"
    ...
    <Button
      ...
      :class="[
        'flex-1 rounded-full hover:bg-muted',
        activeTab === '/operator/requests' ? 'bg-muted text-primary' : '',
      ]"
    ...
    <Button
      ...
      :class="[
        'flex-1 rounded-full hover:bg-muted',
        activeTab === '/operator/heatmap' ? 'bg-muted text-primary' : '',
      ]"
    ...
    <Button
      ...
      :class="[
        'flex-1 rounded-full hover:bg-muted',
        activeTab === '/operator/dashboard' ? 'bg-muted text-primary' : '',
      ]"
